  ...
  return (
    <header className="bg-gray-300">
      ...
      <ul className="flex g-1">
        ...
        <li className="pr-4"><VscAccount size={20}/></li>
        <li> <AiOutlineShoppingCart size={20}/></li>
        </ul>
      ...
      <nav className={!nav ? 'bg-gray-300 fixed left-0 top-0 w-[60%] h-full border-r-gray-900 uppercase ease-in-out duration-500': 'fixed left-[-100%]'}>
